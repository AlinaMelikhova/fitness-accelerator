...
var _teamCards = require("./modules/team-cards");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _teamCards.handlerTeamMembers)();
  // ---------------------------------
...
},{"./modules/form-validate/form":3,"./modules/modals/init-modals":9,"./modules/swiper/swiper":11,"./modules/team-cards":12,"./modules/youtube":13,"./utils/ios-vh-fix":16,"./vendor/init-accordion":19,"./vendor/init-tabs":20}],2:[function(require,module,exports){
"use strict";
...
var initTeamSwiper = function initTeamSwiper() {
  // eslint-disable-next-line no-new
  new _swiper.default('.swiper-team', {
...
exports.handlerTeamMembers = void 0;
var breakpoint = window.matchMedia('(min-width:1200px)');
var handlerTeamMembers = function handlerTeamMembers() {
  if (!breakpoint.matches) {
    Array.from(document.querySelectorAll('.team__item-container')).forEach(function (member) {
      member.addEventListener('click', function () {
        if (member.classList.contains('is-opened')) {
          member.querySelector('.team__item-hover-container').style.display = 'none';
          member.querySelector('.team__item-name').style.display = 'block';
        } else {
          member.querySelector('.team__item-hover-container').style.display = 'block';
...
exports.handlerTeamMembers = handlerTeamMembers;
...
var videoContainer = document.querySelector('.about__multimedia-video-container');
var videoPoster = document.querySelector('.about__multimedia-video-cover');
var videoButton = document.querySelector('.about__video-cover-button');
...
var initAccordions = function initAccordions() {
  ...
  Array.from(document.querySelectorAll('.faq__accordeon-list')).forEach(function (accordion) {
...
var initTabs = function initTabs() {
  ...
  var tabsParents = document.querySelectorAll('[data-tabs="parent"]');
  Array.from(tabsParents).forEach(function (tab) {
    var buttons = tab.querySelectorAll('[data-tabs="control"]');
    var contents = tab.querySelectorAll('[data-tabs="element"]');
    var lengthDiff = buttons.length - contents.length;
    if (lengthDiff === 0) {
      return;
    }
    Array.from(buttons).reverse().slice(0, lengthDiff).forEach(function (button) {
      return delete button.dataset.tabs;
    });
  });
